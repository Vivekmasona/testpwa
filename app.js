...
ytproDownDiv.innerHTML+="<span style='position:absolute;top:15px;left:15px;color:yellow;font-size:30px;' onclick='"+"this.parentElement.parentElement.style.display="+'"'+"none"+'"'+";'>&#x2715;</span>Select Avilaible Quality<ul id='listurl'>";
...
ytproAudDivElem.style.borderTop="3px solid yellow";
ytproAudX.style.borderTop="3px solid yellow";
ytproAudX.style.borderRight="3px solid yellow";
ytproAudX.style.position="absolute";
ytproAudX.style.top="-43.25px";
ytproAudX.style.color="yellow";
